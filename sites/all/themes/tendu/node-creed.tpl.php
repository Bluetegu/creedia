<div id="node-<?php print $node->nid; ?>" class="node-creed node<?php if ($sticky) { print ' sticky'; } ?><?php if (!$status) { print ' node-unpublished'; } ?>">
   ...
   <div class="creed-footer">
	...
	<div class="date-author">
	  <?php print t('!date by  ', array('!date' => date("d M Y", $node->changed))); ?>
	    ...
	    <?php print theme('ctwitter_fb_share', $node); ?>
      </div>
  </div>
  <?php else: ?>
  <?php /* ------------------    page == 1    ------------------ */ ?>
	...
	<div class="body">
	  ...
	  <h4><label><?php print t('Exposition:')?></label></h4>
	  <?php print $node->content['body']['#value'] ?>
	  <?php endif; ?>
	</div>
      </div>
	...
	<div class="childnum">
	  <a href="#interpretations"><span>
	    <?php print t('Interpretations: !num', array('!num' => $intnum)); ?>
	  </span></a>
	</div>
	<div class="childnum">
