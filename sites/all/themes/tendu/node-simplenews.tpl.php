<div id="node-<?php print $node->nid; ?>" class="node-simplenews node<?php if ($sticky) { print ' sticky'; } ?><?php if (!$status) { print ' node-unpublished'; } ?>">
...
<div class="node-full">
  <div class="simplenews-main">
    <?php echo $picture; ?>
    <h2 class="title">
    <a href="<?php print $node_url ?>" class="simplenews-title" title="<?php print $title ?>"><?php print $title ?></a>
    </h2>
    <div class="body">
      <?php print $node->content['body']['#value']; ?>
    </div>
