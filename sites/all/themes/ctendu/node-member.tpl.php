<div id="node-<?php print $node->nid; ?>" class="node-member node<?php if ($sticky) { print ' sticky'; } ?><?php if (!$status) { print ' node-unpublished'; } ?>">
  ...
  <?php /* ------------------    page == 1    ------------------ */ ?>
    ...
    <div class="node-full node-full-no-teaser">
      <div class="member-main-full">
	    ...
	    <table>
	      <tr class="fullname">
		<td class="label"><?php print $fullname_label; ?></td>
		<td><?php print $fullname ? $fullname : print $empty; ?></td>
	      </tr>
	      <tr class="username">
		<td class="label"><?php print $username_label; ?></td>
		<td><?php print $name; ?></td>
	      </tr>
	      <tr class="joined">
		<td class="label"><?php print t('Joined '); ?></td>
		...
		<td><?php print theme('religion', $religion, 'link'); ?></td>
	      </tr>
		...
		<td>
	      ...
	      <tr class="religion">
		<td class="label"><?php print $religion_label; ?></td>
		<td><?php print $empty ?></td>
	      </tr>
	      <?php } ?>
	      <tr class="gender">
		<td class="label"><?php print $gender_label; ?></td>
		<td><?php print $gender ? theme('gender', $gender, 'both') : $empty; ?></td>
	      </tr>
	      <tr class="country">
		<td class="label"><?php print $country_label; ?></td>
		<td><?php if (!empty($countries)) { ?>
		  <?php foreach($countries as $country) { ?>
		  <?php print theme('country', $country, 'both'); ?>
		  <?php } ?>
		  <?php } else { ?>
		  <?php print $empty; ?>
		  <?php } ?></td>
		...
		<tr class="oneliner">
		  <td class="label"><?php print $oneliner_label; ?></td>
		  <td><?php print $oneliner ? $oneliner : $empty; ?></td>
		</tr>
		<?php if ($dob): ?>
		<tr class="dob">
		  <td class="label"><?php print $dob_label; ?></td>
		  <td><?php print $dob; ?></td>
		</tr>
		<?php endif; ?>
                <?php if ($homepages): ?>
		...
		<tr class="homepage">
		  <td class="label"><?php print $homepage_label; ?></td>
		  <td><?php print $homepage; ?></td>
		</tr>
		<?php } ?>
                <?php endif; ?>
		...
		<tr class="communitypage">
		  <td class="label"><?php print $communitypage_label; ?></td>
		  <td><?php print $communitypage; ?></td>
		</tr>
		<?php } ?>
                <?php endif; ?>
		<?php if ($twittername): ?>
		<tr class="twittername">
		  <td class="label"><?php print $twittername_label; ?></td>
		  <td><?php print $twittername; ?></td>
		</tr>
		<?php endif; ?>
	      </table>
	    </div>
