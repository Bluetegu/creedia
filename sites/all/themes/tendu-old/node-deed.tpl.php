<div id="node-<?php print $node->nid; ?>" class="node-deed node<?php if ($sticky) { print ' sticky'; } ?><?php if (!$status) { print ' node-unpublished'; } ?>">
...
<div class="body">
  ...
  <?php endif; ?>
	...
	<?php foreach ($countries as $term) { ?>
	  <div class="country"><?php print theme('term', $term); ?></div>
	<?php }; ?>
      <?php };?>
      <?php if ($religions) { ?>
	...
	<?php }; ?>
      ...
      <?php if ($freetag) { ?>
        <?php foreach ($freetag as $term) { ?>
	      <div class="freetag"><?php print theme('freetag', $term); ?></div>
	    <?php }; ?>
      <?php };?>
    </div>
</div>
...
<div class="node-full">
  <div class="deed-main">
    ...
    <h2 class="title">
    <a href="<?php print $node_url ?>" class="deed-title" title="<?php print $title ?>"><?php print $title ?></a>
    </h2>
    <div class="image"> 
