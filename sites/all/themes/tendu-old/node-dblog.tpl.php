<div id="node-<?php print $node->nid; ?>" class="node-blog node<?php if ($sticky) { print ' sticky'; } ?><?php if (!$status) { print ' node-unpublished'; } ?>">
...
<div class="node-full">
  <div class="blog-main">
    <?php echo $picture; ?>
    <h2 class="title">
    <a href="<?php print $node_url ?>" class="blog-title" title="<?php print $title ?>"><?php print $title ?></a>
    </h2>
    <div class="image"> 
